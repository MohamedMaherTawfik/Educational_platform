    ...
    <div class="flex h-full">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-12 right-side">
            <div class="w-full max-w-md">
                <h2 class="text-3xl font-bold text-white mb-8">New Account</h2>

                <form action="{{ route('signup') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div class="relative my-6 text-white">
                        <div class="absolute inset-0 flex items-center">
                            <div class="w-full border-t border-gray-700"></div>
                        </div>
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-black text-white">or</span>
                        </div>
                    </div>
                    ...
                    <p class="text-white text-sm text-center mt-6">
                        Already have an account? <a href="{{ route('login') }}" class="text-white hover:text-white-400 opacity-100">Sign in</a>
                    </p>
                </form>
            </div>
        </div>
