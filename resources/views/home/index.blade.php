...
<body class="bg-white">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div class="relative">
                ...
                <img src="{{ asset('images/about_main.webp') }}" alt="Main hoodie"
                    class="rounded-lg w-full object-cover h-64 sm:h-80 md:h-96">
    ...
    <div class="bg-white py-12 md:py-16 px-4 sm:px-6">
    ...
    <section class="bg-gradient-to-r from-gray-100 to-indigo-700 text-black py-12 md:py-16 px-4 sm:px-6">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10">
            <!-- Text Content -->
            <div class="md:w-1/2 text-center md:text-left">
                <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight text-black">
            ...
            <div class="md:w-1/2 mt-8 md:mt-0">
                <img src="{{ asset('images/advertising.jpg') }}" alt="Advertising"
                    class="rounded-xl shadow-lg w-full h-auto max-h-64 object-cover">
            </div>
        </div>
    </section>
