    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/help" class="text-gray-500 hover:text-gray-800">Help Center</a></li>
                    <li><a href="/terms" class="text-gray-500 hover:text-gray-800">Terms of Service</a></li>
                    <li><a href="/privacy" class="text-gray-500 hover:text-gray-800">Privacy Policy</a></li>
                </ul>
            </div>
            <div>
